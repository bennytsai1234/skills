...
description: "Codebase Atlas for {{PROJECT_NAME}} — navigation map and change discipline. Load once at the start of work on this project; do not re-invoke later in the same conversation."
---
