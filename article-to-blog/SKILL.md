...
- 有沒有至少一段作者判斷
- 字數是否夠長、但不是灌水
- **是否為繁體中文**：發布前必須檢查全文是否為繁體中文，若發現簡體字需修正後再發布

### 繁體中文檢查規則

發布前必須執行以下檢查：

1. **掃描簡體字**：使用 `grep -c` 搜尋以下常見簡體字：
   - 这、那、为、于、时、间、没、有、这、么、什么、怎么、这个、那个、变成、变成、成为、可以、自己、因为、所以、但是、然后、现在、已经、以及、以及、开始、的话、的话、什么、没有、自己、这个、那个、变成、成为、可以、因为、所以、但是、然后、现在、已经、还有、以及、开始、如果、的话、学习、工作、人们、我们、你们、他们、这个、那个、这些、那些、自己、什么、怎么、如何、为什么、因为、所以、但是、而且、或者、所以、如果、的话、这里、那里、这里、什么、怎么、如何、为什么、因为、所以、但是、而且、或者、如果、的话、这里、那里、这里、什么、怎么、如何、为什么、因为、所以、但是、而且、或者

2. **若發現簡體字**：
   - 先用 `sed` 或重新 write 將所有簡體字置換為繁體
   - 重新 build 確認無誤後再 push

3. **確認發布**：所有簡體字修正完畢後才能執行 build + push
